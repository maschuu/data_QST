...
# Comparing a system of n qubits with a system of m qubits. For a given AD strength gammam in the m qubit system we compute the AD strength gamman in the n qubit system
